---
description: "SQL and Database development standards for DBIx::Class and MySQL"
globs: ["Comserv/lib/Comserv/Model/Schema/Ency/Result/**", "Comserv/sql/**"]
alwaysApply: false
---
...
- **Result Classes**: Located in `Comserv/lib/Comserv/Model/Schema/Ency/Result/`.
