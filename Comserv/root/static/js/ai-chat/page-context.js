...
(function () {
    ...
    var STATIC_NAV = [
        ...
        { label: 'git',                        url: '/admin/git' },
        { label: 'git dashboard',              url: '/admin/git' },
        { label: 'git pull',                   url: '/admin/git' },
        { label: 'git push',                   url: '/admin/git' },
        { label: 'git commit',                 url: '/admin/git' },
        { label: 'git status',                 url: '/admin/git' },
        { label: 'git stash',                  url: '/admin/git' },
        { label: 'branches',                   url: '/admin/git' },
        { label: 'branch management',          url: '/admin/git' },
        { label: 'source control',             url: '/admin/git' },
