...
[% PageVersion = 'todo/add_project.tt,v 0.02 2025/10/04 shanta Exp shanta ' %]
[% IF debug_mode == 1 %]
    [% PageVersion %]
[% END %]
...
[% INCLUDE "todo/project_list.tt" projects=projects selected_project_id=form_data.parent_id field_name="parent_id" %]<br>
