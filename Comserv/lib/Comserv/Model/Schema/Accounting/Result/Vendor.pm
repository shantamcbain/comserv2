package Comserv::Model::Schema::Accounting::Result::Vendor;
use strict;
use warnings;
...
__PACKAGE__->add_columns(
    ...
    vendornumber      => { data_type => 'varchar', size => 255, is_nullable => 1 },
...
__PACKAGE__->has_many('invoices', 'Comserv::Model::Schema::Accounting::Result::Ap',
