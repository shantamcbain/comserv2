...
__PACKAGE__->add_unique_constraint(unique_customer_invoice_number => [qw/sitename invoice_number/]);

__PACKAGE__->belongs_to(
    'customer_order',
    'Comserv::Model::Schema::Ency::Result::InventoryCustomerOrder',
...
__PACKAGE__->has_many(
    'lines',
    'Comserv::Model::Schema::Ency::Result::InventoryCustomerInvoiceLine',
