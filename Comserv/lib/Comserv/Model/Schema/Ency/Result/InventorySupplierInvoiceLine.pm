package Comserv::Model::Schema::Ency::Result::InventorySupplierInvoiceLine;
use strict;
use warnings;
...
__PACKAGE__->belongs_to(
    'invoice',
    'Comserv::Model::Schema::Ency::Result::InventorySupplierInvoice',
...
__PACKAGE__->belongs_to(
    'location',
    'Comserv::Model::Schema::Ency::Result::InventoryLocation',
