package Comserv::Model::Schema::Ency::Result::InternalCurrencyAccount;
...
__PACKAGE__->has_many(
    transactions_received => 'Comserv::Model::Schema::Ency::Result::InternalCurrencyTransaction',
    { 'foreign.to_user_id' => 'self.user_id' }
);

__PACKAGE__->has_many(
    transactions_sent => 'Comserv::Model::Schema::Ency::Result::InternalCurrencyTransaction',
