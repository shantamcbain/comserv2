package Comserv::Model::Schema::Ency::Result::Beekeeping::QueenEnhanced;
...
__PACKAGE__->belongs_to(
    'current_yard',
    'Comserv::Model::Schema::Ency::Result::Beekeeping::Yard',
    'current_yard_id',
    { is_deferrable => 1, on_delete => 'SET NULL', join_type => 'LEFT' }
);
...
__PACKAGE__->belongs_to(
    'current_pallet',
    'Comserv::Model::Schema::Ency::Result::Accounting::Pallet',
    'current_pallet_id',
    { is_deferrable => 1, on_delete => 'SET NULL', join_type => 'LEFT' }
);
