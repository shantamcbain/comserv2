package Comserv::Model::Schema::Ency::Result::Beekeeping::Hive;
...
__PACKAGE__->has_many(
    'treatments',
    'Comserv::Model::Schema::Ency::Result::Ency::Treatment',
    'hive_id',
    { cascade_delete => 1 }
);
...
__PACKAGE__->has_many(
    'hive_components',
    'Comserv::Model::Schema::Ency::Result::Beekeeping::HiveComponent',
