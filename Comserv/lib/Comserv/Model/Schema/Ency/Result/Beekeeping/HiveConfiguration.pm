package Comserv::Model::Schema::Ency::Result::Beekeeping::HiveConfiguration;
...
__PACKAGE__->has_many(
    ...
    'Comserv::Model::Schema::Ency::Result::Beekeeping::HiveConfigurationHistory',
...
__PACKAGE__->has_many(
    'hive_assemblies',
    'Comserv::Model::Schema::Ency::Result::Beekeeping::HiveAssembly',
    'configuration_id',
    { cascade_delete => 1 }
);
...
__PACKAGE__->has_many(
    'configuration_boxes',
    'Comserv::Model::Schema::Ency::Result::Beekeeping::ConfigurationBox',
    'configuration_id',
    { cascade_delete => 1 }
);
...
__PACKAGE__->has_many(
    ...
    'Comserv::Model::Schema::Ency::Result::Accounting::ConfigurationInventory',
    'configuration_id',
    { cascade_delete => 1 }
);
