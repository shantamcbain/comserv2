...
[ACTION: {"action": "navigate_and_fill", "url": "/Accounting/transfer/new", "fields": {"entry_type": "prepaid_topup", "amount": "DEPOSIT_AMOUNT", "post_date": "YYYY-MM-DD", "reference": "REFERENCE_NO", "notes": "e.g. PayPal account refill shantahostgator May 2026", "fee_amount": "CONVENIENCE_FEE_IF_ANY"}}]
