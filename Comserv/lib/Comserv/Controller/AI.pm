...
The prompt instructs the AI to:
  1. Answer support questions using knowledge base guidance
  2. Offer to help create a support ticket
  3. Suggest escalation to a live agent for urgent issues
  4. Be aware of the current site context
