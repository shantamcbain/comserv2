...
sub seed_coa :Path('/Accounting/coa/seed') :Args(0) {
    ...
    my @default_accounts = (
        # Assets
        { accno => '1000', description => 'Cash',                       link => 'AR_paid:AP_paid', category => 'A' },
        { accno => '1100', description => 'Accounts Receivable',        link => 'AR',              category => 'A' },
        { accno => '1200', description => 'Inventory Asset',            link => 'IC',              category => 'A' },
        { accno => '1300', description => 'Prepaid Expenses',           link => '',                category => 'A' },
        { accno => '1500', description => 'Fixed Assets',               link => '',                category => 'A' },
        # Liabilities
        { accno => '2000', description => 'Accounts Payable',           link => 'AP',              category => 'L' },
        { accno => '2100', description => 'Sales Tax Payable',          link => '',                category => 'L' },
        { accno => '2200', description => 'Accrued Liabilities',        link => '',                category => 'L' },
        # Equity
        { accno => '3000', description => "Owner's Equity",             link => '',                category => 'Q' },
        { accno => '3100', description => 'Retained Earnings',          link => '',                category => 'Q' },
        # Income
        { accno => '4000', description => 'Sales Revenue',              link => 'AR_amount',       category => 'I' },
        { accno => '4100', description => 'Sales Returns & Allowances', link => '',                category => 'I' },
        { accno => '4200', description => 'Service Revenue',            link => '',                category => 'I' },
        { accno => '4900', description => 'Other Income',               link => '',                category => 'I' },
        # Cost of Goods Sold / Expenses
        { accno => '5000', description => 'Cost of Goods Sold',         link => 'IC_cogs',         category => 'E' },
        { accno => '5100', description => 'Purchases',                  link => 'AP_amount',       category => 'E' },
        { accno => '6000', description => 'General & Administrative',   link => '',                category => 'E' },
        { accno => '6100', description => 'Wages & Salaries',           link => '',                category => 'E' },
        { accno => '6200', description => 'Supplies Expense',           link => '',                category => 'E' },
        { accno => '6300', description => 'Equipment Expense',          link => '',                category => 'E' },
        { accno => '6400', description => 'Shipping & Postage',         link => '',                category => 'E' },
        { accno => '6500', description => 'Depreciation Expense',       link => '',                category => 'E' },
        { accno => '6900', description => 'Other Expenses',             link => '',                category => 'E' },
    );
