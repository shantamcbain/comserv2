...
# Legacy docker endpoints removed — all Docker functionality is now handled by
# Comserv::Controller::Admin::Docker (/admin/docker/* routes) with the new
# modular JS/CSS and theme-compliant templates at admin/docker/docker_containers.tt.
# See Admin/Docker.pm for the new implementation.

# (removed — legacy docker_volumes endpoint)

# Legacy docker endpoints removed — see Admin/Docker.pm for the new implementation.
#-------------------------------------------------------------------------------
sub end : Private {
    my ($self, $c) = @_;
